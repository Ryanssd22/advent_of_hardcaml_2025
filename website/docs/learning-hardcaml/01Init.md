...
<img src={require('/static/memes/ocamlmeme.jpg').default} alt="OCaml meme" width="400px" />
...
But I thought it would be more fun to try out funtional programming, specifically OCaml;
I've heard many praise the functional programming, _(or at least the haskell can't stop talking about it)_,
so it could help me learn some more
...
you can use **WSL** _(which is goated)_.
